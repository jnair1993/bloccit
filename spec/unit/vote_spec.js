...
describe("Vote", () => {
  ...
  describe("#create()", () => {
    ...
    it("should create an upvote on a post for a user", (done) => {
      ...
      Vote.create({value: 1, postId: this.post.id, userId: this.user.id}).then((vote) => {
  ...
  describe("#getUser()", () => {
    ...
    it("should return the associated user", (done) => {
      Vote.create({value: 1, userId: this.user.id, postId: this.post.id}).then((vote) => {
